...
class NearestNeighborIndexTest(unittest.TestCase):
    ...
    def test_benchmark(self):
        ...
        index_points = [rand_point() for _ in range(10000)]#10000
        query_points = [rand_point() for _ in range(1000)]#1000
        ...
        start = time.time()
        for query_point in query_points:
            actual.append(NearestNeighborIndex.find_nearest(query_point,index_points))
        ...
        #show menu to display points
        simple_example.show_menu()
